		...
		if next_state == self.StatePrepared:
			...
			if self.justplay:
				...
				if RecordTimerEntry.wasInDeepStandby:
					...
					if Screens.Standby.inStandby: #In case some plugin did put the STB already in standby
