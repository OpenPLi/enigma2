...
// Global flag to remember if AIO is not supported (detected at runtime)
// Once set, all future threads will use sync mode without trying AIO
...
// eDVBRecordScrambledThread implementation
