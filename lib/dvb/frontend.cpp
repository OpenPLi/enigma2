...
int eDVBFrontend::openFrontend()
{
	...
	m_use_dvbapi5_statistics = m_dvbversion >= DVB_VERSION(5, 10) && (!strstr(m_description, "FTM-4862 (Availink AVL6862)") && !strstr(m_description, "Sundtek"));
