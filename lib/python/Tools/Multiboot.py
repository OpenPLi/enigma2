...
def GetCurrentImage():
	return SystemInfo["canMultiBoot"] and (int(open('/sys/firmware/devicetree/base/chosen/bootargs', 'r').read()[:-1].split(SystemInfo["canMultiBoot"][2]+'p')[1].split(' ')[0])-SystemInfo["canMultiBoot"][0])/2
