...
SystemInfo["canMultiBoot"] = HardwareInfo().get_device_model() in ('h7', 'hd51', 'vs1500')
...
SystemInfo["HasFullHDSkinSupport"] = HardwareInfo().get_device_model() not in ("et4000", "et5000", "hd500c", "hd1100", "lc", "sh1", "xp1000")
...
SystemInfo["HasMMC"] = HardwareInfo().get_device_model() in ('et11000', 'galaxy4k', 'gbquad4k', 'h7', 'hd51', 'hd52', 'linux', 'lunix3-4k', 'vs1500', 'vusolo4k', 'vusolo4kse', 'vuuno4k', 'vuuno4kse', 'vuultimo4k', 'vuzero4k')
SystemInfo["HasMultichannelPCM"] = fileCheck("/proc/stb/audio/multichannel_pcm")
SystemInfo["HasOfflineDecoding"] = HardwareInfo().get_device_model() not in ('et7000', 'et7000mini', 'et8500', 'et11000', 'mbmicro', 'mbmicrov2', 'mbtwinplus', 'osmini', 'osminiplus')
SystemInfo["hasPIPVisibleProc"] = fileCheck("/proc/stb/vmpeg/1/visible")
SystemInfo["HasSoftcamInstalled"] = hassoftcaminstalled()
SystemInfo["HasTranscoding"] = pathExists("/proc/stb/encoder/0") or fileCheck("/dev/bcm_enc0")
SystemInfo["hasXcoreVFD"] = HardwareInfo().get_device_model() in ('osmega', 'spycat4k', 'spycat4kcombo', 'spycat4kmini') and fileCheck("/sys/module/brcmstb_%s/parameters/pt6302_cgram" % HardwareInfo().get_device_model())
