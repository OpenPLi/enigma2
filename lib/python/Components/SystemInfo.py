...
def setBoxInfoItems():
	...
	BoxInfo.setItem("RcTypeChangable", not (model in ("gbue4k", "gbquad4k", "gbquad4kpro") or model.startswith("et7")) and pathExists("/proc/stb/ir/rc/type"))
	...
	BoxInfo.setItem("HasFrontDisplayPicon", model in ("et8500", "vusolo4k", "vuuno4kse", "vuduo4k", "vuduo4kse", "vuultimo4k", "gbquad4k", "gbquad4kpro", "gbue4k"))
	...
	BoxInfo.setItem("HasComposite", model not in ("i55", "gbquad4k", "gbquad4kpro", "gbue4k", "hd1500", "osnino", "osninoplus", "purehd", "purehdse", "revo4k", "vusolo4k", "vuzero4k", "vuduo4k", "vuduo4kse", "vuuno4k", "vuuno4kse", "vuultimo4k"))
