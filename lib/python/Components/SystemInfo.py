...
SystemInfo["WakeOnLAN"] = not (HardwareInfo().get_device_model().startswith('et8000') or HardwareInfo().get_device_model().startswith('et10000')) and fileCheck("/proc/stb/power/wol") or fileCheck("/proc/stb/fp/wol")
