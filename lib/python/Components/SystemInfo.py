...
SystemInfo["HasFullHDSkinSupport"] = HardwareInfo().get_device_model() not in ("et4000", "et5000", "sh1", "hd500c", "hd1100", "xp1000")
...
SystemInfo["HasHDMI-CEC"] = HardwareInfo().has_hdmi()
