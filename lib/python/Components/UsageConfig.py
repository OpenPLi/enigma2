...
def InitUsageConfig():
	...
	if SystemInfo["12_to_8_characterVFD"]:
		def set12to8characterVFD(configElement):
			open(SystemInfo["12_to_8_characterVFD"], "w").write(configElement.value == "8" and "1" or "0")
		config.usage.toggle12to8characterVFD = ConfigSelection(default = "8", choices = [("12", "12"),("8", "8")])
