...
class ChoiceBox(Screen):
	def __init__(self, session, title="", list=[], keys=None, selection=0, skin_name=[], reorderConfig="", windowTitle="Select"):
		...
		self.setTitle(windowTitle == "Select" and _("Select") or windowTitle)
