...
class VirtualKeyBoard(Screen, HelpableScreen):
	def __init__(self, session, title=_("Virtual KeyBoard Text:"), text="", maxSize=False, visible_width=False, type=Input.TEXT, currPos=0, allMarked=False):
		...
		if fileExists(resolveFilename(SCOPE_CURRENT_SKIN, 'buttons/vkey_backspace.png')):
			...
			self.key_bg = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_bg.png"))
			self.key_red_bg = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_red.png"))
			self.key_green_bg = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_green.png"))
			self.key_yellow_bg = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_yellow.png"))
			self.key_blue_bg = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_blue.png"))
			self.key_sel = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_sel.png"))
			self.key_backspace = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_backspace.png"))
			self.key_enter = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_enter.png"))
			self.key_first = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_first.png"))
			self.key_last = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_last.png"))
			self.key_left = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_left.png"))
			self.key_right = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_right.png"))
			self.key_shift0 = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_shift0.png"))
			self.key_shift1 = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_shift1.png"))
			self.key_shift2 = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_shift2.png"))
			self.key_shift3 = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_shift3.png"))
			self.key_space = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_space.png"))
			self.key_space_alt = LoadPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "vkey_space_alt.png"))
		self.keyBackgrounds = {
