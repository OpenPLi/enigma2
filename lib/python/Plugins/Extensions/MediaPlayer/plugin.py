...
def filescan(**kwargs):
	...
	return [
		...
		Scanner(mimetypes = ["audio/mpeg", "audio/x-wav", "application/ogg", "audio/x-flac", "audio/dts", "audio/ogg", "audio/flac", "audio/mp4", "audio/x-ms-wma", "audio/ac3", "audio/x-matroska", "audio/x-aac", "audio/x-monkeys-audio"],
			paths_to_scan =
				[
					ScanPath(path = "", with_subdirs = False),
				],
