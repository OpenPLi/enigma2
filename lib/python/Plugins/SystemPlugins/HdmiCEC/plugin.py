...
class HdmiCECSetupScreen(Screen, ConfigListScreen):
	...
	def createSetup(self):
		...
		if config.hdmicec.enabled.value:
			...
			self.list.append(getConfigListEntry(_("Put STB in standby"), config.hdmicec.control_receiver_standby))
			self.list.append(getConfigListEntry(_("Wakeup STB from standby"), config.hdmicec.control_receiver_wakeup))
