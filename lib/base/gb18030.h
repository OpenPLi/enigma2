...
static int
gb18030ext_mbtowc (ucs4_t *pwc, const unsigned char *s, int n)
{
...
static int
gb18030uni_mbtowc (ucs4_t *pwc, const unsigned char *s, int n)
{
  unsigned char c1 = s[0];
  if (c1 >= 0x81 && c1 <= 0x84) {
    if (n >= 2) {
...
static int
gb2312_mbtowc(ucs4_t *pwc, const unsigned char *s, int n)
{
  unsigned char c1 = s[0];
