...
protected:
	...
	bool csa_from_whitelist() { return eConfigManager::getConfigIntValue("config.misc.softcam_softcsa", 0) == 1 && eConfigManager::getConfigBoolValue("config.misc.softcam_use_softcsa", false); };
};
